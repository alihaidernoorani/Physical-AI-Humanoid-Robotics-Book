...
<Diagram
  ...
  caption="Unity-ROS 2 communication architecture showing publishers, subscribers, and service interactions"
/>
...
<Quiz
  ...
  options={[
    ...
    "To manage network communication between Unity and ROS 2",
    "To handle Unity's physics simulation",
    "To create 3D models in Unity"
  ]}
  correctAnswer="To manage network communication between Unity and ROS 2"
...
<Diagram
  ...
  caption="Message flow between Unity and ROS 2 showing publishers and subscribers for different sensor types"
/>
...
<Quiz
  ...
  options={[
    ...
    "Service-based only",
    "Both publisher-subscriber and service-based",
    "Neither publisher-subscriber nor service-based"
  ]}
  correctAnswer="Both publisher-subscriber and service-based"
...
<Diagram
  ...
  caption="Unity physics engine architecture showing collision detection and rigid body systems for humanoid robot interaction"
/>
...
<Quiz
  ...
  options={[
    ...
    "To enable simulation of complex articulated objects like doors and drawers",
    "To reduce simulation performance",
    "To create 3D models"
  ]}
  correctAnswer="To enable simulation of complex articulated objects like doors and drawers"
...
<Diagram
  ...
  caption="Environment asset pipeline from 3D modeling to Unity integration for humanoid simulation"
/>
...
<Quiz
  ...
  options:[
    "To improve visual quality only" || "To reduce visual quality only" || "To balance visual fidelity with performance requirements" ||
    "To eliminate the need for optimization"
  ]}
  correctAnswer="To balance visual fidelity with performance requirements"
